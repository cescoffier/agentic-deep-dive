...
public class Agents {
    ...
    public interface ExchangeAgent {
        @UserMessage("""
            ...
            """)
        @Agent(outputName = "exchange", description = "A money exchanger that converts a given amount of money from the original to the target currency")
        @ToolBox(ExchangeTool.class)
